...
global_declaration :        typedef_declaration
                            ...
                            ;
typedef_declaration :       T_TYPEDEF typename listspec T_ID dims T_SEMI        {hashtbl_insert(htable,$4,NULL,scope);}
                            ;
typename :                  standard_type
                            | T_ID                                              {hashtbl_insert(htable,$1,NULL,scope);}
                            ;
...
init_values :               init_values T_COMMA init_value
                            | init_value
enum_declaration :          T_ENUM T_ID enum_body T_SEMI                        {hashtbl_insert(htable,$2,NULL,scope);}
                            ;
...
initializer :               T_ASSIGN init_value
                            | %empty         {;}
                            ;
class_declaration :         T_CLASS T_ID class_body T_SEMI                      {hashtbl_insert(htable,$2,NULL,scope);};
...
variabledef :               listspec T_ID dims                                  {hashtbl_insert(htable,$2,NULL,scope);};
...
func_header_start :         typename listspec T_ID                              {hashtbl_insert(htable,$3,NULL,scope); scope++; };
...
union_declaration :         T_UNION T_ID union_body T_SEMI                      {hashtbl_insert(htable,$2,NULL,scope);};
...
full_par_func_header :      class_func_header_start T_LPAREN parameter_list T_RPAREN
                            ...
                            ;
class_func_header_start :   typename listspec func_class T_ID                   {hashtbl_insert(htable,$4,NULL,scope); scope++; };
